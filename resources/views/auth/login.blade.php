...
<body class="bg-white dark:bg-dark-bg text-gray-900 dark:text-dark-text font-sans min-h-screen flex flex-col items-center justify-center p-6">
    ...
    <div class="w-full max-w-[400px]">
        <div class="text-center mb-10">
            ...
            <h1 class="text-3xl font-bold tracking-tight">Xush kelibsiz</h1>
        </div>
        ...
        <div class="bg-white dark:bg-dark-secondary/50 border border-gray-100 dark:border-dark-border rounded-3xl p-8 shadow-xl">
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-5">
                ...
                <div class="flex items-center justify-between px-1 text-sm">
                    <label class="flex items-center gap-2 cursor-pointer group">
                        <input type="checkbox" name="remember" class="w-4 h-4 rounded-md border-gray-300 text-green-500 focus:ring-green-500">
                        <span class="text-gray-600 dark:text-dark-muted group-hover:text-gray-900 dark:group-hover:text-dark-text transition-colors">Eslab qolish</span>
                    </label>
                    @if (Route::has('password.request'))
                        <a href="{{ route('password.request') }}" class="text-green-500 font-medium hover:underline">Parolni unutdingizmi?</a>
                    @endif
                </div>
            ...
            <div class="mt-8 text-center text-sm">
                ...
                <a href="{{ route('register') }}" class="text-green-500 font-bold hover:underline ml-1">Ro'yxatdan o'ting</a>
            </div>
        </div>
